...
class Binance:
    ...
    def __init__(self):
        ...
        self.tf_all_table = [['1m', 'realtime_btc_minute', 1, 'BTC/USDT'], ['5m', 'realtime_btc_5minute', 5, 'BTC/USDT'], ['15m', 'realtime_btc_15minute', 15, 'BTC/USDT'],['15m', 'realtime_eth_15minute', 15, 'ETH/USDT'],
                    ['1h', 'realtime_btc_hour', 60, 'BTC/USDT'], ['1h', 'realtime_eth_hour', 60, 'ETH/USDT'],['1h', 'realtime_ada_hour', 60, 'ADA/USDT'],
                             ['4h', 'realtime_btc_4hour', 240, 'BTC/USDT'],['4h', 'realtime_eth_4hour', 240, 'ETH/USDT'],['4h', 'realtime_eth_hour', 240, 'ADA/USDT'],
                         ['1d', 'realtime_btc_day', 3600, 'BTC/USDT'],['1d', 'realtime_eth_day', 3600, 'ETH/USDT'], ['1d', 'realtime_ada_hour', 3600, 'ADA/USDT']]  # 1열은 timeframe, 2열은 테이블 명
        self.tf_table = [['5m', 'realtime_btc_5minute', 5, 'BTC/USDT'], ['15m', 'realtime_eth_15minute', 15, 'ETH/USDT'], ['1h','realtime_ada_hour', 60, 'ADA/USDT']]
    ...
    def clear_realtime_table(self):
        ...
        print("================================================================================")
    def minute_to_mysql(self, table, timeframe, ticker):
        OHLCV = self.binanceObj.fetch_ohlcv(ticker, timeframe=timeframe, limit=100)  # 1번 반복이 한시간 +3600000 24시간 +86400000
    ...
    def are_algos_working(self):
        ...
        for i in not_working_algo:
            if i == 'algo2_pre_low':
                print("algo#2 재 진입")
                stObj.algo2_pre_low('realtime_btc_5minute', 'BTC/USDT')
                stObj.algo2_pre_low('realtime_eth_15minute', 'ETH/USDT')
                stObj.algo2_pre_low('realtime_ada_hour', 'ADA/USDT')
            if i == 'algo3_pre_high':
                print("algo#3 재 진입")
                stObj.algo3_pre_high('realtime_btc_5minute', 'BTC/USDT')
    ...
    def main(self):
        ...
        for tf in self.tf_table:  # 각 분봉, 시간봉, 일봉 당 최근 100개의 데이터 mysql에 저장
            self.minute_to_mysql(tf[1], tf[0], tf[3])
